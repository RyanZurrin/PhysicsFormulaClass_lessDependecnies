...
public:
    ...
    {
        int x; ///< X_ position of the mouse pointer, relative to the left of the owner window
        int y; ///< Y_ position of the mouse pointer, relative to the top of the owner window
    };
    ...
    struct TouchEvent
    {
        ...
        int x;               ///< X_ position of the touch, relative to the left of the owner window
        int y;               ///< Y_ position of the touch, relative to the top of the owner window
    };
    ...
    struct SensorEvent
    {
        ...
        float x;           ///< Current value of the sensor on X_ axis
        float y;           ///< Current value of the sensor on Y_ axis
        float z;           ///< Current value of the sensor on Z_ axis
    };
