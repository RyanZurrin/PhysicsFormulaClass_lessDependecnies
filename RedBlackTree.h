...
#ifndef PHYSICSFORMULA_REDBLACKTREE_H
#define PHYSICSFORMULA_REDBLACKTREE_H
#pragma once
...
namespace rez {
    ...
    template<class KType, class VType, class Compare>
    void RedBlackTree<KType, VType, Compare>::insert(std::list<KType>& _list)
    {
...
#endif //PHYSICSFORMULA_REDBLACKTREE_H
